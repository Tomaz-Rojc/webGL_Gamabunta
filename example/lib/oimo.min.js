...
!function (t, i) {
    ...
    var s, h, e, a, o = "1.0.9", n = 0, r = 1, l = 2, c = 3, m = 0, p = 0, u = 1, y = 2, x = 3, d = 4, f = 5, b = 0,
        v = 1, z = 2, N = 3, k = 4, w = 5, M = 6, g = {
            sqrt: Math.sqrt,
            abs: Math.abs,
            floor: Math.floor,
            cos: Math.cos,
            ...
            distance: function (t, i) {
                var s = i[0] - t[0], h = i[1] - t[1], e = i[2] - t[2];
            ...
            distanceVector: function (t, i) {
                var s = t.x - i.x, h = t.y - i.y, e = t.z - i.z;
                return s * s + h * h + e * e
            },
    ...
    Object.assign(V.prototype, {
        ...
        Vec3: !0, set: function (t, i, s) {
            ...
            var s = this.x, h = this.y, e = this.z, a = t.elements;
            ...
            var i = this.x, s = this.y, h = this.z, e = t.x, a = t.y, o = t.z, n = t.w, r = n * i + a * h - o * s,
                l = n * s + o * i - e * h, c = n * h + e * s - a * i, m = -e * i - a * s - o * h;
        ...
        Quat: !0, set: function (t, i, s, h) {
            return this.x = t, this.y = i, this.z = s, this.w = h, this
        }, addTime: function (t, i) {
            var s = t.x, h = t.y, e = t.z, a = this.w, o = this.x, n = this.y, r = this.z;
            ...
            var s = t.x, h = t.y, e = t.z, a = t.w, o = i.x, n = i.y, r = i.z, l = i.w;
            ...
            var h = Math.cos(.5 * t), e = Math.cos(.5 * i), a = Math.cos(.5 * s), o = Math.sin(.5 * t),
                n = Math.sin(.5 * i), r = Math.sin(.5 * s);
        ...
        Mat33: !0, set: function (t, i, s, h, e, a, o, n, r) {
            ...
            var h = this.elements, e = t.elements, a = i.elements, o = e[0], n = e[3], r = e[6], l = e[1], c = e[4],
                m = e[7], p = e[2], u = e[5], y = e[8], x = a[0], d = a[3], f = a[6], b = a[1], v = a[4], z = a[7],
                N = a[2], k = a[5], w = a[8];
            ...
            var s = this.elements, h = s[1], e = s[2], a = s[5];
            return s[1] = s[3], s[2] = s[6], s[3] = h, s[5] = s[7], s[6] = e, s[7] = a, this
        }, setQuat: function (t) {
            var i = this.elements, s = t.x, h = t.y, e = t.z, a = t.w, o = s + s, n = h + h, r = e + e, l = s * o,
                c = s * n, m = s * r, p = h * n, u = h * r, y = e * r, x = a * o, d = a * n, f = a * r;
            return i[0] = 1 - (p + y), i[1] = c - f, i[2] = m + d, i[3] = c + f, i[4] = 1 - (l + y), i[5] = u - x, i[6] = m - d, i[7] = u + x, i[8] = 1 - (l + p), this
        }, invert: function (t) {
            var i = this.elements, s = t.elements, h = s[0], e = s[3], a = s[6], o = s[1], n = s[4], r = s[7], l = s[2],
                c = s[5], m = s[8], p = m * n - c * r, u = -m * e + c * a, y = r * e - n * a, x = h * p + o * u + l * y;
            ...
            var s = i.x, h = i.y, e = i.z, a = this.elements;
            a[0] += t * (h * h + e * e), a[4] += t * (s * s + e * e), a[8] += t * (s * s + h * h);
            var o = t * s * h, n = t * h * e, r = t * e * s;
            ...
            var t = this.elements, i = t[0], s = t[1], h = t[2], e = t[3], a = t[4], o = t[5], n = t[6], r = t[7],
                l = t[8];
        ...
        AABB: !0, set: function (t, i, s, h, e, a) {
            var o = this.elements;
            ...
            var t = this.elements, i = t[3] - t[0], s = t[4] - t[1], h = t[5] - t[2];
            return 2 * (i * (s + h) + s * h)
    ...
    Object.assign(j.prototype, {
        ...
        constructor: C, calculateMassInfo: function (t) {
            ...
            var t = this.rotation.elements, i = this.dimentions;
            ...
            var s = i[9], h = i[10], e = i[11], a = i[12], o = i[13], n = i[14], r = i[15], l = i[16], c = i[17],
                m = this.position.x, p = this.position.y, u = this.position.z, y = this.elements;
            ...
            var x = i[9] < 0 ? -i[9] : i[9], d = i[10] < 0 ? -i[10] : i[10], f = i[11] < 0 ? -i[11] : i[11];
        ...
        constructor: D, calculateMassInfo: function (t) {
            var i = this.radius * this.radius, s = g.PI * i * this.height * this.density,
                h = (.25 * i + .0833 * this.height * this.height) * s, e = .5 * i;
        ...
        constructor: E, volume: function () {
            return Number.MAX_VALUE
        }, calculateMassInfo: function (t) {
            t.mass = this.density;
            t.inertia.set(1, 0, 0, 0, 1, 0, 0, 0, 1)
        }, updateProxy: function () {
            var t = .005, i = -g.INF, s = g.INF, h = this.normal;
        ...
        LimitMotor: !0, setLimit: function (t, i) {
        ...
        Constraint: !0, preSolve: function (t, i) {
        ...
        constructor: _, setId: function (t) {
            this.id = i
            ...
            if (t) this.body1.jointLink.splice(this.body1.jointLink.indexOf(this.b1Link), 1), this.body2.jointLink.splice(this.body2.jointLink.indexOf(this.b2Link), 1); else {
                var i = this.b1Link.prev, s = this.b1Link.next;
        ...
        LinearConstraint: !0, preSolve: function (t, i) {
            ...
            var s = this.ii1.elements, h = this.ii2.elements;
            ...
            var e = this.m1 + this.m2, a = (new P).set(e, 0, 0, 0, e, 0, 0, 0, e).elements;
            ...
            var t = this.dd.elements,
                ...
                e = i * t[0] + s * t[1] + h * t[2], a = i * t[3] + s * t[4] + h * t[5],
                o = i * t[6] + s * t[7] + h * t[8];
        ...
        Rotational3Constraint: !0, preSolve: function (t, i) {
            ...
            var s = this.i1.elements, h = this.i2.elements;
            ...
            var e = this.limitMotor1.frequency, a = this.limitMotor2.frequency, o = this.limitMotor3.frequency,
                n = e > 0, r = a > 0, l = o > 0, c = this.lowerLimit1 <= this.upperLimit1,
                m = this.lowerLimit2 <= this.upperLimit2, p = this.lowerLimit3 <= this.upperLimit3,
            ...
            if (p ? (this.lowerLimit3 == this.upperLimit3 ? (0 != this.limitState3 && (this.limitState3 = 0, this.limitImpulse3 = 0), this.limitVelocity3 = this.lowerLimit3 - x) : x < this.lowerLimit3 ? (-1 != this.limitState3 && (this.limitState3 = -1, this.limitImpulse3 = 0), this.limitVelocity3 = this.lowerLimit3 - x) : x > this.upperLimit3 ? (1 != this.limitState3 && (this.limitState3 = 1, this.limitImpulse3 = 0), this.limitVelocity3 = this.upperLimit3 - x) : (this.limitState3 = 2, this.limitImpulse3 = 0, this.limitVelocity3 = 0), l || (this.limitVelocity3 > .02 ? this.limitVelocity3 -= .02 : this.limitVelocity3 < -.02 ? this.limitVelocity3 += .02 : this.limitVelocity3 = 0)) : (this.limitState3 = 2, this.limitImpulse3 = 0), this.enableMotor1 && (0 != this.limitState1 || n) ? this.maxMotorImpulse1 = this.maxMotorForce1 * t : (this.motorImpulse1 = 0, this.maxMotorImpulse1 = 0), this.enableMotor2 && (0 != this.limitState2 || r) ? this.maxMotorImpulse2 = this.maxMotorForce2 * t : (this.motorImpulse2 = 0, this.maxMotorImpulse2 = 0), this.enableMotor3 && (0 != this.limitState3 || l) ? this.maxMotorImpulse3 = this.maxMotorForce3 * t : (this.motorImpulse3 = 0, this.maxMotorImpulse3 = 0), this.a1x1 = this.ax1 * this.i1e00 + this.ay1 * this.i1e01 + this.az1 * this.i1e02, this.a1y1 = this.ax1 * this.i1e10 + this.ay1 * this.i1e11 + this.az1 * this.i1e12, this.a1z1 = this.ax1 * this.i1e20 + this.ay1 * this.i1e21 + this.az1 * this.i1e22, this.a2x1 = this.ax1 * this.i2e00 + this.ay1 * this.i2e01 + this.az1 * this.i2e02, this.a2y1 = this.ax1 * this.i2e10 + this.ay1 * this.i2e11 + this.az1 * this.i2e12, this.a2z1 = this.ax1 * this.i2e20 + this.ay1 * this.i2e21 + this.az1 * this.i2e22, this.a1x2 = this.ax2 * this.i1e00 + this.ay2 * this.i1e01 + this.az2 * this.i1e02, this.a1y2 = this.ax2 * this.i1e10 + this.ay2 * this.i1e11 + this.az2 * this.i1e12, this.a1z2 = this.ax2 * this.i1e20 + this.ay2 * this.i1e21 + this.az2 * this.i1e22, this.a2x2 = this.ax2 * this.i2e00 + this.ay2 * this.i2e01 + this.az2 * this.i2e02, this.a2y2 = this.ax2 * this.i2e10 + this.ay2 * this.i2e11 + this.az2 * this.i2e12, this.a2z2 = this.ax2 * this.i2e20 + this.ay2 * this.i2e21 + this.az2 * this.i2e22, this.a1x3 = this.ax3 * this.i1e00 + this.ay3 * this.i1e01 + this.az3 * this.i1e02, this.a1y3 = this.ax3 * this.i1e10 + this.ay3 * this.i1e11 + this.az3 * this.i1e12, this.a1z3 = this.ax3 * this.i1e20 + this.ay3 * this.i1e21 + this.az3 * this.i1e22, this.a2x3 = this.ax3 * this.i2e00 + this.ay3 * this.i2e01 + this.az3 * this.i2e02, this.a2y3 = this.ax3 * this.i2e10 + this.ay3 * this.i2e11 + this.az3 * this.i2e12, this.a2z3 = this.ax3 * this.i2e20 + this.ay3 * this.i2e21 + this.az3 * this.i2e22, this.k00 = this.ax1 * (this.a1x1 + this.a2x1) + this.ay1 * (this.a1y1 + this.a2y1) + this.az1 * (this.a1z1 + this.a2z1), this.k01 = this.ax1 * (this.a1x2 + this.a2x2) + this.ay1 * (this.a1y2 + this.a2y2) + this.az1 * (this.a1z2 + this.a2z2), this.k02 = this.ax1 * (this.a1x3 + this.a2x3) + this.ay1 * (this.a1y3 + this.a2y3) + this.az1 * (this.a1z3 + this.a2z3), this.k10 = this.ax2 * (this.a1x1 + this.a2x1) + this.ay2 * (this.a1y1 + this.a2y1) + this.az2 * (this.a1z1 + this.a2z1), this.k11 = this.ax2 * (this.a1x2 + this.a2x2) + this.ay2 * (this.a1y2 + this.a2y2) + this.az2 * (this.a1z2 + this.a2z2), this.k12 = this.ax2 * (this.a1x3 + this.a2x3) + this.ay2 * (this.a1y3 + this.a2y3) + this.az2 * (this.a1z3 + this.a2z3), this.k20 = this.ax3 * (this.a1x1 + this.a2x1) + this.ay3 * (this.a1y1 + this.a2y1) + this.az3 * (this.a1z1 + this.a2z1), this.k21 = this.ax3 * (this.a1x2 + this.a2x2) + this.ay3 * (this.a1y2 + this.a2y2) + this.az3 * (this.a1z2 + this.a2z2), this.k22 = this.ax3 * (this.a1x3 + this.a2x3) + this.ay3 * (this.a1y3 + this.a2y3) + this.az3 * (this.a1z3 + this.a2z3), this.kv00 = this.k00, this.kv11 = this.k11, this.kv22 = this.k22, this.dv00 = 1 / this.kv00, this.dv11 = 1 / this.kv11, this.dv22 = 1 / this.kv22, n && 2 != this.limitState1) {
                var d = 6.2831853 * e, f = d * d * t, b = i / (f + 2 * this.limitMotor1.dampingRatio * d);
            ...
            var z = this.limitImpulse1 + this.motorImpulse1, N = this.limitImpulse2 + this.motorImpulse2,
            ...
            var t = this.a2.x - this.a1.x, i = this.a2.y - this.a1.y, s = this.a2.z - this.a1.z;
            ...
            var h = t * this.ax1 + i * this.ay1 + s * this.az1 - this.limitVelocity1,
                ...
                o = h * this.d00 + e * this.d01 + a * this.d02, n = h * this.d10 + e * this.d11 + a * this.d12,
            ...
            var t = this.a2.x - this.a1.x, i = this.a2.y - this.a1.y, s = this.a2.z - this.a1.z,
                h = t * this.ax1 + i * this.ay1 + s * this.az1, e = t * this.ax2 + i * this.ay2 + s * this.az2,
                a = t * this.ax3 + i * this.ay3 + s * this.az3, o = this.motorImpulse1, n = this.motorImpulse2,
                r = this.motorImpulse3, l = 0, c = 0, m = 0;
            ...
            var p = this.limitImpulse1, u = this.limitImpulse2, y = this.limitImpulse3,
                x = h * this.d00 + e * this.d01 + a * this.d02, d = h * this.d10 + e * this.d11 + a * this.d12,
        ...
        constructor: H, preSolve: function (t, i) {
        ...
        constructor: Q, preSolve: function (t, i) {
        ...
        TranslationalConstraint: !0, preSolve: function (t, i) {
            ...
            var s = this.i1.elements, h = this.i2.elements;
            this.i1e00 = s[0], this.i1e01 = s[1], this.i1e02 = s[2], this.i1e10 = s[3], this.i1e11 = s[4], this.i1e12 = s[5], this.i1e20 = s[6], this.i1e21 = s[7], this.i1e22 = s[8], this.i2e00 = h[0], this.i2e01 = h[1], this.i2e02 = h[2], this.i2e10 = h[3], this.i2e11 = h[4], this.i2e12 = h[5], this.i2e20 = h[6], this.i2e21 = h[7], this.i2e22 = h[8];
            var e = this.p2.x - this.p1.x, a = this.p2.y - this.p1.y, o = this.p2.z - this.p1.z,
                n = e * this.ax + a * this.ay + o * this.az, r = this.limitMotor.frequency, l = r > 0;
            ...
            var c = n * this.ax, m = n * this.ay, p = n * this.az, u = this.m1 / (this.m1 + this.m2), y = 1 - u;
            if (this.r1x = this.r1.x + c * u, this.r1y = this.r1.y + m * u, this.r1z = this.r1.z + p * u, this.r2x = this.r2.x - c * y, this.r2y = this.r2.y - m * y, this.r2z = this.r2.z - p * y, this.t1x = this.r1y * this.az - this.r1z * this.ay, this.t1y = this.r1z * this.ax - this.r1x * this.az, this.t1z = this.r1x * this.ay - this.r1y * this.ax, this.t2x = this.r2y * this.az - this.r2z * this.ay, this.t2y = this.r2z * this.ax - this.r2x * this.az, this.t2z = this.r2x * this.ay - this.r2y * this.ax, this.l1x = this.ax * this.m1, this.l1y = this.ay * this.m1, this.l1z = this.az * this.m1, this.l2x = this.ax * this.m2, this.l2y = this.ay * this.m2, this.l2z = this.az * this.m2, this.a1x = this.t1x * this.i1e00 + this.t1y * this.i1e01 + this.t1z * this.i1e02, this.a1y = this.t1x * this.i1e10 + this.t1y * this.i1e11 + this.t1z * this.i1e12, this.a1z = this.t1x * this.i1e20 + this.t1y * this.i1e21 + this.t1z * this.i1e22, this.a2x = this.t2x * this.i2e00 + this.t2y * this.i2e01 + this.t2z * this.i2e02, this.a2y = this.t2x * this.i2e10 + this.t2y * this.i2e11 + this.t2z * this.i2e12, this.a2z = this.t2x * this.i2e20 + this.t2y * this.i2e21 + this.t2z * this.i2e22, this.motorDenom = this.m1 + this.m2 + this.ax * (this.a1y * this.r1z - this.a1z * this.r1y + this.a2y * this.r2z - this.a2z * this.r2y) + this.ay * (this.a1z * this.r1x - this.a1x * this.r1z + this.a2z * this.r2x - this.a2x * this.r2z) + this.az * (this.a1x * this.r1y - this.a1y * this.r1x + this.a2x * this.r2y - this.a2y * this.r2x), this.invMotorDenom = 1 / this.motorDenom, l && 2 != this.limitState) {
                var x = 6.2831853 * r, d = x * x * t, f = i / (d + 2 * this.limitMotor.dampingRatio * x);
        ...
        constructor: Y, preSolve: function (t, i) {
        ...
        AngularConstraint: !0, preSolve: function (t, i) {
            var s, h, e;
        ...
        Translational3Constraint: !0, preSolve: function (t, i) {
            this.ax1 = this.limitMotor1.axis.x, this.ay1 = this.limitMotor1.axis.y, this.az1 = this.limitMotor1.axis.z, this.ax2 = this.limitMotor2.axis.x, this.ay2 = this.limitMotor2.axis.y, this.az2 = this.limitMotor2.axis.z, this.ax3 = this.limitMotor3.axis.x, this.ay3 = this.limitMotor3.axis.y, this.az3 = this.limitMotor3.axis.z, this.lowerLimit1 = this.limitMotor1.lowerLimit, this.upperLimit1 = this.limitMotor1.upperLimit, this.motorSpeed1 = this.limitMotor1.motorSpeed, this.maxMotorForce1 = this.limitMotor1.maxMotorForce, this.enableMotor1 = this.maxMotorForce1 > 0, this.lowerLimit2 = this.limitMotor2.lowerLimit, this.upperLimit2 = this.limitMotor2.upperLimit, this.motorSpeed2 = this.limitMotor2.motorSpeed, this.maxMotorForce2 = this.limitMotor2.maxMotorForce, this.enableMotor2 = this.maxMotorForce2 > 0, this.lowerLimit3 = this.limitMotor3.lowerLimit, this.upperLimit3 = this.limitMotor3.upperLimit, this.motorSpeed3 = this.limitMotor3.motorSpeed, this.maxMotorForce3 = this.limitMotor3.maxMotorForce, this.enableMotor3 = this.maxMotorForce3 > 0, this.m1 = this.b1.inverseMass, this.m2 = this.b2.inverseMass;
            var s = this.i1.elements, h = this.i2.elements;
            this.i1e00 = s[0], this.i1e01 = s[1], this.i1e02 = s[2], this.i1e10 = s[3], this.i1e11 = s[4], this.i1e12 = s[5], this.i1e20 = s[6], this.i1e21 = s[7], this.i1e22 = s[8], this.i2e00 = h[0], this.i2e01 = h[1], this.i2e02 = h[2], this.i2e10 = h[3], this.i2e11 = h[4], this.i2e12 = h[5], this.i2e20 = h[6], this.i2e21 = h[7], this.i2e22 = h[8];
            var e = this.p2.x - this.p1.x, a = this.p2.y - this.p1.y, o = this.p2.z - this.p1.z,
                n = e * this.ax1 + a * this.ay1 + o * this.az1, r = e * this.ax2 + a * this.ay2 + o * this.az2,
                l = e * this.ax3 + a * this.ay3 + o * this.az3, c = this.limitMotor1.frequency,
                m = this.limitMotor2.frequency, p = this.limitMotor3.frequency, u = c > 0, y = m > 0, x = p > 0,
                d = this.lowerLimit1 <= this.upperLimit1, f = this.lowerLimit2 <= this.upperLimit2,
            ...
            var v = n * this.ax1 + r * this.ax2 + l * this.ax2, z = n * this.ay1 + r * this.ay2 + l * this.ay2,
                N = n * this.az1 + r * this.az2 + l * this.az2, k = this.m2 / (this.m1 + this.m2);
            ...
            if (this.k00 = (this.ax1 * this.ax1 + this.ay1 * this.ay1 + this.az1 * this.az1) * M, this.k01 = (this.ax1 * this.ax2 + this.ay1 * this.ay2 + this.az1 * this.az2) * M, this.k02 = (this.ax1 * this.ax3 + this.ay1 * this.ay3 + this.az1 * this.az3) * M, this.k10 = (this.ax2 * this.ax1 + this.ay2 * this.ay1 + this.az2 * this.az1) * M, this.k11 = (this.ax2 * this.ax2 + this.ay2 * this.ay2 + this.az2 * this.az2) * M, this.k12 = (this.ax2 * this.ax3 + this.ay2 * this.ay3 + this.az2 * this.az3) * M, this.k20 = (this.ax3 * this.ax1 + this.ay3 * this.ay1 + this.az3 * this.az1) * M, this.k21 = (this.ax3 * this.ax2 + this.ay3 * this.ay2 + this.az3 * this.az2) * M, this.k22 = (this.ax3 * this.ax3 + this.ay3 * this.ay3 + this.az3 * this.az3) * M, this.k00 += this.t1x1 * this.a1x1 + this.t1y1 * this.a1y1 + this.t1z1 * this.a1z1, this.k01 += this.t1x1 * this.a1x2 + this.t1y1 * this.a1y2 + this.t1z1 * this.a1z2, this.k02 += this.t1x1 * this.a1x3 + this.t1y1 * this.a1y3 + this.t1z1 * this.a1z3, this.k10 += this.t1x2 * this.a1x1 + this.t1y2 * this.a1y1 + this.t1z2 * this.a1z1, this.k11 += this.t1x2 * this.a1x2 + this.t1y2 * this.a1y2 + this.t1z2 * this.a1z2, this.k12 += this.t1x2 * this.a1x3 + this.t1y2 * this.a1y3 + this.t1z2 * this.a1z3, this.k20 += this.t1x3 * this.a1x1 + this.t1y3 * this.a1y1 + this.t1z3 * this.a1z1, this.k21 += this.t1x3 * this.a1x2 + this.t1y3 * this.a1y2 + this.t1z3 * this.a1z2, this.k22 += this.t1x3 * this.a1x3 + this.t1y3 * this.a1y3 + this.t1z3 * this.a1z3, this.k00 += this.t2x1 * this.a2x1 + this.t2y1 * this.a2y1 + this.t2z1 * this.a2z1, this.k01 += this.t2x1 * this.a2x2 + this.t2y1 * this.a2y2 + this.t2z1 * this.a2z2, this.k02 += this.t2x1 * this.a2x3 + this.t2y1 * this.a2y3 + this.t2z1 * this.a2z3, this.k10 += this.t2x2 * this.a2x1 + this.t2y2 * this.a2y1 + this.t2z2 * this.a2z1, this.k11 += this.t2x2 * this.a2x2 + this.t2y2 * this.a2y2 + this.t2z2 * this.a2z2, this.k12 += this.t2x2 * this.a2x3 + this.t2y2 * this.a2y3 + this.t2z2 * this.a2z3, this.k20 += this.t2x3 * this.a2x1 + this.t2y3 * this.a2y1 + this.t2z3 * this.a2z1, this.k21 += this.t2x3 * this.a2x2 + this.t2y3 * this.a2y2 + this.t2z3 * this.a2z2, this.k22 += this.t2x3 * this.a2x3 + this.t2y3 * this.a2y3 + this.t2z3 * this.a2z3, this.kv00 = this.k00, this.kv11 = this.k11, this.kv22 = this.k22, this.dv00 = 1 / this.kv00, this.dv11 = 1 / this.kv11, this.dv22 = 1 / this.kv22, u && 2 != this.limitState1) {
                var g = 6.2831853 * c, I = g * g * t, V = i / (I + 2 * this.limitMotor1.dampingRatio * g);
            ...
            var S = this.limitImpulse1 + this.motorImpulse1, P = this.limitImpulse2 + this.motorImpulse2,
        ...
        constructor: G, preSolve: function (t, i) {
        ...
        constructor: $, preSolve: function (t, i) {
        ...
        constructor: tt, preSolve: function (t, i) {
        ...
        constructor: ot, reset: function (t, i) {
        ...
        constructor: rt, attach: function () {
        ...
        Contact: !0, mixRestitution: function (t, i) {
            return g.sqrt(t * i)
            ...
            for (var t = this.manifold.numPoints, i = t; i--;) {
                var s = this.buffer[i], h = this.points[i];
            ...
            for ((this.touching || this.dist < .001) && (this.close = !0), this.touching = !0, i = e; i--;) {
                for (var a = (h = this.points[i]).localPoint1.x, o = h.localPoint1.y, n = h.localPoint1.z, r = h.localPoint2.x, l = h.localPoint2.y, c = h.localPoint2.z, m = -1, p = 4e-4, u = t; u--;) {
                    var y = (s = this.buffer[u]).lp1X - a, x = s.lp1Y - o, d = s.lp1Z - n, f = y * y + x * x + d * d,
            ...
            var t = this.s1Link.prev, i = this.s1Link.next;
        ...
        BroadPhase: !0, createProxy: function (t) {
    ...
    Object.assign(yt.prototype, {
        ...
        constructor: dt, createProxy: function (t) {
            ...
            var t, i, s, h = 0, e = this.proxies, a = e.length;
            for (this.numPairChecks = a * (a - 1) >> 1; h < a;) for (i = e[h++], t = h + 1; t < a;) s = e[t++], !i.aabb.intersectTest(s.aabb) && this.isAvailablePair(i.shape, s.shape) && this.addPair(i.shape, s.shape)
        }
    }), Object.assign(ft.prototype, {
        SAPAxis: !0, addElements: function (t, i) {
            ...
            if (s) {
                ...
                for (c[0] = 0, c[1] = this.numElements - 1; t > 0;) {
                    ...
                    } else for (e = p + 1; e <= m; e++) if (n = (o = h[e]).value, (r = h[e - 1]).value > n) {
                        l = e;
                        do {
                            if (h[l] = r, 0 == --l) break;
                            r = h[l - 1]
        ...
        constructor: vt, isDynamic: function () {
        ...
        constructor: zt, createProxy: function (t) {
            ...
            if (0 != this.numElementsD) {
                var t, i, s, h, e = this.axesD[this.index1], a = this.axesD[this.index2];
        ...
        DBVT: !0, moveLeaf: function (t) {
            ...
            var i = t.height;
            if (i < 2) return t;
            var s, h = t.parent, e = t.child1, a = t.child2, o = e.height, n = a.height, r = o - n;
            if (r > 1) {
                var l = e.child1, c = e.child2, m = l.height, p = c.height;
            ...
            if (r < -1) {
                var u = a.child1, y = a.child2, x = u.height, d = y.height;
        ...
        constructor: wt, update: function () {
        }
    }), Mt.prototype = Object.assign(Object.create(pt.prototype), {
        constructor: Mt, createProxy: function (t) {
            return new wt(t)
        }, addProxy: function (t) {
            ...
            if (!(this.numLeaves < 2)) for (var t, i = this.numLeaves; i--;) (t = this.leaves[i]).proxy.aabb.intersectTestTwo(t.aabb) && (t.aabb.copy(t.proxy.aabb, .1), this.tree.deleteLeaf(t), this.tree.insertLeaf(t), this.collide(t, this.tree.root))
        }, collide: function (t, i) {
            var s, h, e, a, o, n, r = 2;
            for (this.stack[0] = t, this.stack[1] = i; r > 0;) if (e = this.stack[--r], a = this.stack[--r], o = null != e.proxy, n = null != a.proxy, this.numPairChecks++, o && n) {
        ...
        CollisionDetector: !0, detectCollision: function (t, i, s) {
            I("CollisionDetector", "Inheritance error.")
        }
    }), It.prototype = Object.assign(Object.create(gt.prototype), {
        constructor: It, detectCollision: function (t, i, s) {
            var h, e;
            t.id < i.id ? (h = t, e = i) : (h = i, e = t);
            var a, o, n, r, l, c, m, p, u, y, x, d, f, b, v, z, N, k, w, M, I, V, L, S, P, T, A, j, C, O, D, E, B, F, q,
                U = h.elements, R = e.elements, _ = h.dimentions, J = e.dimentions, W = h.position, H = e.position,
                Q = W.x, X = W.y, Y = W.z, Z = H.x, K = H.y, G = H.z, $ = Z - Q, tt = K - X, it = G - Y,
                st = h.halfWidth, ht = h.halfHeight, et = h.halfDepth, at = e.halfWidth, ot = e.halfHeight,
                nt = e.halfDepth, rt = _[0], lt = _[1], ct = _[2], mt = _[3], pt = _[4], ut = _[5], yt = _[6],
                xt = _[7], dt = _[8], ft = _[9], bt = _[10], vt = _[11], zt = _[12], Nt = _[13], kt = _[14], wt = _[15],
                Mt = _[16], gt = _[17], It = J[0], Vt = J[1], Lt = J[2], St = J[3], Pt = J[4], Tt = J[5], At = J[6],
                jt = J[7], Ct = J[8], Ot = J[9], Dt = J[10], Et = J[11], Bt = J[12], Ft = J[13], qt = J[14], Ut = J[15],
                Rt = J[16], _t = J[17], Jt = lt * Lt - ct * Vt, Wt = ct * It - rt * Lt, Ht = rt * Vt - lt * It,
                Qt = lt * Tt - ct * Pt, Xt = ct * St - rt * Tt, Yt = rt * Pt - lt * St, Zt = lt * Ct - ct * jt,
                Kt = ct * At - rt * Ct, Gt = rt * jt - lt * At, $t = pt * Lt - ut * Vt, ti = ut * It - mt * Lt,
                ii = mt * Vt - pt * It, si = pt * Tt - ut * Pt, hi = ut * St - mt * Tt, ei = mt * Pt - pt * St,
                ai = pt * Ct - ut * jt, oi = ut * At - mt * Ct, ni = mt * jt - pt * At, ri = xt * Lt - dt * Vt,
                li = dt * It - yt * Lt, ci = yt * Vt - xt * It, mi = xt * Tt - dt * Pt, pi = dt * St - yt * Tt,
                ui = yt * Pt - xt * St, yi = xt * Ct - dt * jt, xi = dt * At - yt * Ct, di = yt * jt - xt * At, fi = !1,
                bi = !1, vi = !1, zi = !1, Ni = !1, ki = !1, wi = !1, Mi = !1, gi = !1;
            if ((a = (D = rt * $ + lt * tt + ct * it) > 0) || (D = -D), (B = rt * It + lt * Vt + ct * Lt) < 0 && (B = -B), (F = rt * St + lt * Pt + ct * Tt) < 0 && (F = -F), (q = rt * At + lt * jt + ct * Ct) < 0 && (q = -q), !((z = D - (E = st) - (B * at + F * ot + q * nt)) > 0 || ((o = (D = mt * $ + pt * tt + ut * it) > 0) || (D = -D), (B = mt * It + pt * Vt + ut * Lt) < 0 && (B = -B), (F = mt * St + pt * Pt + ut * Tt) < 0 && (F = -F), (q = mt * At + pt * jt + ut * Ct) < 0 && (q = -q), (N = D - (E = ht) - (B * at + F * ot + q * nt)) > 0 || ((n = (D = yt * $ + xt * tt + dt * it) > 0) || (D = -D), (B = yt * It + xt * Vt + dt * Lt) < 0 && (B = -B), (F = yt * St + xt * Pt + dt * Tt) < 0 && (F = -F), (q = yt * At + xt * jt + dt * Ct) < 0 && (q = -q), (k = D - (E = et) - (B * at + F * ot + q * nt)) > 0 || ((r = (D = It * $ + Vt * tt + Lt * it) > 0) || (D = -D), (B = It * rt + Vt * lt + Lt * ct) < 0 && (B = -B), (F = It * mt + Vt * pt + Lt * ut) < 0 && (F = -F), (q = It * yt + Vt * xt + Lt * dt) < 0 && (q = -q), (w = 1 * (D - (E = B * st + F * ht + q * et) - at)) > 0 || ((l = (D = St * $ + Pt * tt + Tt * it) > 0) || (D = -D), (B = St * rt + Pt * lt + Tt * ct) < 0 && (B = -B), (F = St * mt + Pt * pt + Tt * ut) < 0 && (F = -F), (q = St * yt + Pt * xt + Tt * dt) < 0 && (q = -q), (M = 1 * (D - (E = B * st + F * ht + q * et) - ot)) > 0 || ((c = (D = At * $ + jt * tt + Ct * it) > 0) || (D = -D), (B = At * rt + jt * lt + Ct * ct) < 0 && (B = -B), (F = At * mt + jt * pt + Ct * ut) < 0 && (F = -F), (q = At * yt + jt * xt + Ct * dt) < 0 && (q = -q), (I = 1 * (D - (E = B * st + F * ht + q * et) - nt)) > 0))))))) {
                ...
                var Pi = 0, Ti = 0, Ai = 0, ji = 0, Ci = 0, Oi = 0, Di = 0, Ei = 0, Bi = 0, Fi = 0, qi = 0, Ui = 0,
                    Ri = 0, _i = 0, Ji = 0, Wi = 0, Hi = 0, Qi = 0, Xi = !1;
                            ...
                            if (0 != (vs = zs)) {
                                ...
                                if (0 != (vs = zs)) {
                                    ...
                                    if (vs > 4) {
                                        ...
                                        var Cs = 0, Os = 0, Ds = 0, Es = 0, Bs = -this.INF;
                                    ...
                                    } else for (Ts = 0; Ts < vs; Ts++) Ns = 3 * Ts, (Ss = ((ks = this.clipVertices1[Ns]) - Fi) * Pi + ((ws = this.clipVertices1[Ns + 1]) - qi) * Ti + ((Ms = this.clipVertices1[Ns + 2]) - Ui) * Ai) < 0 && s.addPoint(ks, ws, Ms, Pi, Ti, Ai, Ss, js)
                                }
                            }
                        }
                    }
        ...
        constructor: Vt, getSep: function (t, i, s, h, e) {
            var a, o, n, r, l, c, m, p, u, y, x, d, f, b = new L, v = t.position.x, z = t.position.y, N = t.position.z,
                k = i.position.x, w = i.position.y, M = i.position.z, I = k - v, V = w - z, S = M - N;
            I * I + V * V + S * S == 0 && (V = .001);
            var P = -I, T = -V, A = -S;
            this.supportPointB(t, -P, -T, -A, b);
            var j = b.x, C = b.y, O = b.z;
            this.supportPointC(i, P, T, A, b);
            var D = b.x, E = b.y, B = b.z, F = D - j, q = E - C, U = B - O;
            ...
            this.supportPointB(t, -P, -T, -A, b);
            var R = b.x, _ = b.y, J = b.z;
            this.supportPointC(i, P, T, A, b);
            var W = b.x, H = b.y, Q = b.z, X = W - R, Y = H - _, Z = Q - J;
            ...
            for (var K = 0; ;) {
                if (++K > 100) return !1;
                this.supportPointB(t, -P, -T, -A, b);
                var G = b.x, $ = b.y, tt = b.z;
                this.supportPointC(i, P, T, A, b);
                var it = b.x, st = b.y, ht = b.z, et = it - G, at = st - $, ot = ht - tt;
                ...
                if ((q * ot - U * at) * I + (U * et - F * ot) * V + (F * at - q * et) * S < 0) X = et, Y = at, Z = ot, R = G, _ = $, J = tt, W = it, H = st, Q = ht, P = (o = q - V) * (c = ot - S) - (n = U - S) * (l = at - V), T = n * (r = et - I) - (a = F - I) * c, A = a * l - o * r; else if ((at * Z - ot * Y) * I + (ot * X - et * Z) * V + (et * Y - at * X) * S < 0) F = et, q = at, U = ot, j = G, C = $, O = tt, D = it, E = st, B = ht, P = (o = at - V) * (c = Z - S) - (n = ot - S) * (l = Y - V), T = n * (r = X - I) - (a = et - I) * c, A = a * l - o * r; else for (var nt = !1; ;) {
                    ...
                    this.supportPointB(t, -P, -T, -A, b);
                    var yt = b.x, xt = b.y, dt = b.z;
                    this.supportPointC(i, P, T, A, b);
                    var ft = b.x, bt = b.y, vt = b.z, zt = ft - yt, Nt = bt - xt, kt = vt - dt,
                        wt = -(zt * P + Nt * T + kt * A);
            ...
            var a, o, n, r = t.rotation.elements, l = r[0] * i + r[3] * s + r[6] * h,
                c = r[1] * i + r[4] * s + r[7] * h, m = r[2] * i + r[5] * s + r[8] * h, p = t.halfWidth,
                u = t.halfHeight, y = t.halfDepth;
            ...
            var a, o, n, r = t.rotation.elements, l = r[0] * i + r[3] * s + r[6] * h,
                c = r[1] * i + r[4] * s + r[7] * h, m = r[2] * i + r[5] * s + r[8] * h, p = l, u = m, y = p * p + u * u,
                x = t.radius, d = t.halfHeight;
            ...
            var a = new L, o = new L, n = new L;
            if (this.getSep(h, e, a, o, n)) {
                var r = h.position.x, l = h.position.y, c = h.position.z, m = e.position.x, p = e.position.y,
                    u = e.position.z, y = h.halfWidth, x = h.halfHeight, d = h.halfDepth, f = e.halfHeight,
                    b = e.radius, v = h.dimentions, z = v[0], N = v[1], k = v[2], w = v[3], M = v[4], I = v[5],
                    V = v[6], S = v[7], P = v[8], T = v[9], A = v[10], j = v[11], C = v[12], O = v[13], D = v[14],
                    E = v[15], B = v[16], F = v[17], q = e.normalDirection.x, U = e.normalDirection.y,
                    R = e.normalDirection.z, _ = e.halfDirection.x, J = e.halfDirection.y, W = e.halfDirection.z,
                    H = a.x, Q = a.y, X = a.z, Y = H * z + Q * N + X * k, Z = H * w + Q * M + X * I,
                    K = H * V + Q * S + X * P, G = H * q + Q * U + X * R, $ = Y > 0, tt = Z > 0, it = K > 0, st = G > 0;
                $ || (Y = -Y), tt || (Z = -Z), it || (K = -K), st || (G = -G);
                var ht, et, at, ot, nt, rt, lt, ct, mt, pt, ut, yt, xt, dt, ft, bt, vt, zt, Nt, kt, wt, Mt, gt, It, Vt,
                    Lt, St, Pt, Tt, At, jt, Ct, Ot, Dt, Et, Bt, Ft, qt, Ut, Rt, _t, Jt, Wt, Ht, Qt, Xt, Yt, Zt, Kt, Gt,
                    $t, ti, ii, si = 0;
        ...
        constructor: Lt, getSep: function (t, i, s, h, e) {
            var a, o, n, r, l, c, m, p, u, y, x, d, f, b = new L, v = t.position.x, z = t.position.y, N = t.position.z,
                k = i.position.x, w = i.position.y, M = i.position.z, I = k - v, V = w - z, S = M - N;
            I * I + V * V + S * S == 0 && (V = .001);
            var P = -I, T = -V, A = -S;
            ...
            var h, e;
            t.id < i.id ? (h = t, e = i) : (h = i, e = t);
            var a, o, n, r, l, c, m, p, u, y, x, d, f, b, v, z, N, k, w, M, I, V = h.position, S = e.position, P = V.x,
                T = V.y, A = V.z, j = S.x, C = S.y, O = S.z, D = h.halfHeight, E = e.halfHeight, B = h.normalDirection,
                F = e.normalDirection, q = h.halfDirection, U = e.halfDirection, R = h.radius, _ = e.radius, J = B.x,
                W = B.y, H = B.z, Q = F.x, X = F.y, Y = F.z, Z = q.x, K = q.y, G = q.z, $ = U.x, tt = U.y, it = U.z,
                st = P - j, ht = T - C, et = A - O, at = new L, ot = new L, nt = new L;
            if (this.getSep(h, e, at, ot, nt)) {
                var rt = at.x * J + at.y * W + at.z * H, lt = at.x * Q + at.y * X + at.z * Y, ct = rt > 0, mt = lt > 0;
                ct || (rt = -rt), mt || (lt = -lt);
                var pt, ut, yt, xt = 0;
        ...
        constructor: St, detectCollision: function (t, i, s) {
            var h, e;
            this.flip ? (h = i, e = t) : (h = t, e = i);
            var a, o, n, r, l, c = e.dimentions, m = h.position, p = m.x, u = m.y, y = m.z, x = e.position, d = x.x,
                f = x.y, b = x.z, v = h.radius, z = e.halfWidth, N = e.halfHeight, k = e.halfDepth, w = p - d,
                M = u - f, I = y - b, V = c[0] * w + c[1] * M + c[2] * I, L = c[3] * w + c[4] * M + c[5] * I,
                S = c[6] * w + c[7] * M + c[8] * I, P = 0;
        ...
        detectCollision: function (t, i, s) {
            var h, e;
            this.flip ? (h = i, e = t) : (h = t, e = i);
            var a = h.position, o = a.x, n = a.y, r = a.z, l = e.position, c = l.x, m = l.y, p = l.z,
                u = e.normalDirection.x, y = e.normalDirection.y, x = e.normalDirection.z, d = h.radius, f = e.radius,
                b = d + f, v = e.halfHeight, z = o - c, N = n - m, k = r - p, w = z * u + N * y + k * x;
            if (!(w < -v - d || w > v + d)) {
                var M, I = c + w * u, V = m + w * y, L = p + w * x, S = o - I, P = n - V, T = r - L,
                    A = S * S + P * P + T * T;
        ...
        constructor: Tt,
        detectCollision: function (t, i, s) {
            var h = t, e = i, a = h.position, o = e.position, n = o.x - a.x, r = o.y - a.y, l = o.z - a.z,
                c = n * n + r * r + l * l, m = h.radius, p = m + e.radius;
            if (c > 0 && c < p * p) {
                var u = 1 / (c = g.sqrt(c));
        ...
        constructor: At,
        detectCollision: function (t, i, s) {
            var h, e = this.n, a = this.p, o = this.flip ? i : t, n = this.flip ? t : i, r = o.radius;
        ...
        constructor: jt,
        detectCollision: function (t, i, s) {
            var h, e = this.n, a = this.p, o = this.cc, n = this.flip ? i : t, r = this.flip ? t : i, l = n.dimentions,
                c = n.halfWidth, m = n.halfHeight, p = n.halfDepth, u = 0;
        ...
        World: !0, play: function () {
            ...
            for (t && this.performance.calcBroadPhase(), this.numContactPoints = 0, z = this.contacts; null !== z;) if (z.persisting || !z.shape1.aabb.intersectTest(z.shape2.aabb)) {
                var l = z.body1, c = z.body2;
            ...
            for (var x = this.rigidBodies; null !== x; x = x.next) if (!(x.addedToIsland || x.isStatic || x.sleeping)) if (x.isLonely()) x.isDynamic && x.linearVelocity.addScaledVector(this.gravity, this.timeStep), this.callSleep(x) ? (x.sleepTime += this.timeStep, x.sleepTime > .5 ? x.sleep() : x.updatePosition(this.timeStep)) : (x.sleepTime = 0, x.updatePosition(this.timeStep)), this.numIslands++; else {
                var d = 0, f = 0, b = 1;
                ...
                if (this.enableRandomizer) for (w = f; w--;) if (0 !== w) {
                ...
                if (I > .5) for (w = d; w--;) this.islandRigidBodies[w].sleep(), this.islandRigidBodies[w] = null; else for (w = d; w--;) this.islandRigidBodies[w].updatePosition(this.timeStep), this.islandRigidBodies[w] = null;
                this.numIslands++
            }
            ...
            var s = this.invScale, h = i.move || !1, e = i.kinematic || !1, a = i.pos || [0, 0, 0];
            a = a.map(function (t) {
                return t * s
            });
            ...
            var s, h, e = this.invScale, a = i.axe1 || [1, 0, 0], o = i.axe2 || [1, 0, 0], n = i.pos1 || [0, 0, 0],
                r = i.pos2 || [0, 0, 0];
            n = n.map(function (t) {
                return t * e
            }), r = r.map(function (t) {
            ...
            var l = i.limit || null, c = i.spring || null, m = i.motor || null, p = new it;
